...
[Report a vulnerability](https://github.com/Jott2121/attrition-risk-ml/security/advisories/new)
...
This is explainable ML for retention-risk modeling (scikit-learn, XGBoost, SHAP): a Streamlit UI over a tested `src/` core. Findings of
